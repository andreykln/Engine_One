...
template <typename C>
class DomainShaderConstantBuffer : public Bindable
{
public:
	DomainShaderConstantBuffer(Graphics& gfx, const C& data, UINT in_startSlot, UINT in_numOfBuffers,
	...
	{
		GetContext(gfx)->DSSetConstantBuffers(startSlot, numOfBuffers, pConstBuffer.GetAddressOf());
	}
	ID3D11Buffer* GetDomainShaderConstantBuffer()
	{
