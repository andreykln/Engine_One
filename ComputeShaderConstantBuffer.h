...
template <typename C>
class ComputeShaderConstantBuffer : public Bindable
{
public:
	ComputeShaderConstantBuffer(Graphics& gfx, const C& data, UINT in_startSlot, UINT in_numOfBuffers,
	...
	{
		GetContext(gfx)->CSSetConstantBuffers(startSlot, numOfBuffers, pConstBuffer.GetAddressOf());
	}
	ID3D11Buffer* GetComputeShaderConstantBuffer()
	{
